...
;***
;entry:  _UTILITES_Delay_Ms	;Function start
; 2 exit points
;has an exit
...
_UTILITES_Delay_Ms	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x1049 
	.line	2; "utilites.c"	void UTILITES_Delay_Ms(unsigned int delay_ms)
	BANKSEL	r0x1000
	MOVWF	r0x1000
...
;;	1109 rIdx = r0x104A 
	.line	6; "utilites.c"	for(x = 0 ; x < delay_ms ; x++)
	CLRF	r0x1002
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1109 rIdx = r0x104B 
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7030:genAssign
	.line	8; "utilites.c"	for(y=0; y<120 ; y++)
	MOVLW	0x78
...
_00113_DS_
	RETURN	
; exit point of _UTILITES_Delay_Ms
